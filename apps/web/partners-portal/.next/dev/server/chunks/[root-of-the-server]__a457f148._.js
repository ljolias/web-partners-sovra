...
"[project]/apps/web/partners-portal/src/app/api/partners/training/modules/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$partners$2d$portal$2f$src$2f$lib$2f$auth$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requireSession"])();
        // Get legacy training modules (for backward compatibility)
        const legacyModules = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$partners$2d$portal$2f$src$2f$lib$2f$redis$2f$operations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllTrainingModules"])();
        // Get published courses from admin (new system)
        const publishedCourses = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$partners$2d$portal$2f$src$2f$lib$2f$redis$2f$operations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPublishedTrainingCourses"])();
        // Convert published courses to module format for the frontend
        const coursesAsModules = publishedCourses.map((course)=>{
            ...
            const quizQuestions = course.modules.filter((m)=>m.type === 'quiz' && m.quiz).flatMap((m)=>m.quiz || []).map((q, idx)=>{
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a457f148._.js.map