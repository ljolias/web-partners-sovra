...
"[project]/apps/web/partners-portal/src/app/api/partners/rewards/demo/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
async function GET() {
    const session = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$partners$2d$portal$2f$src$2f$lib$2f$auth$2f$session$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCurrentSession"])();
    if (!session) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            error: 'Unauthorized'
        }, {
    ...
    const results = [];
    // Simulate various actions to earn points
    const actions = [
        {
            action: 'DEAL_CLOSED',
            description: 'Cerró un deal'
        },
        {
            action: 'TRAINING_COMPLETED',
            description: 'Completó un módulo de training'
        },
        {
            action: 'DEAL_CLOSED',
            description: 'Cerró otro deal'
        },
        {
            action: 'COPILOT_SESSION',
            description: 'Usó Copilot'
        },
        {
            action: 'DOCUMENT_SIGNED',
            description: 'Firmó un documento'
        },
        {
            action: 'TRAINING_COMPLETED',
            description: 'Completó otro módulo'
        },
        {
            action: 'DEAL_CLOSED',
            description: 'Cerró un tercer deal (Hat Trick!)'
        },
        {
            action: 'POSITIVE_REVIEW',
            description: 'Recibió una review positiva'
        },
        {
            action: 'REFERRAL',
            description: 'Refirió un nuevo partner'
        },
        {
            action: 'LOGIN_STREAK_7',
            description: 'Login streak de 7 días'
        }
    ];
    console.log(`\n🎮 Demo: Simulando acciones para ${session.partner.name}\n`);
    for (const { action, description } of actions){
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$partners$2d$portal$2f$src$2f$lib$2f$rewards$2f$engine$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["awardPoints"])(partnerId, action);
        results.push({
            description,
        ...
        console.log(`${description}: +${result.points} → ${result.newTotal} total`);
        if (result.achievementsUnlocked.length > 0) {
            console.log(`  🏆 Achievements: ${result.achievementsUnlocked.join(', ')}`);
        }
    }
    console.log('\n✨ Demo completado!\n');
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$29$2e$0_react$2d$dom$40$19$2e$2$2e$3_react$40$19$2e$2$2e$3_$5f$react$40$19$2e$2$2e$3$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__bf11c5c3._.js.map