...
"[project]/apps/web/partners-portal/src/app/api/sovra/deals/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    try {
        ...
        if (statusFilter && statusFilter !== 'all') {
            deals = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$partners$2d$portal$2f$src$2f$lib$2f$redis$2f$operations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDealsByStatus"])(statusFilter);
        } else {
            deals = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$partners$2d$portal$2f$src$2f$lib$2f$redis$2f$operations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAllDeals"])();
        }
        // Enrich deals with partner info
        const dealsWithPartners = await Promise.all(deals.map(async (deal)=>{
            const partner = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$partners$2d$portal$2f$src$2f$lib$2f$redis$2f$operations$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPartner"])(deal.partnerId);
            return {
                ...deal,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e004e232._.js.map